 ...
 */
 // Modification F. NOLOT -> passage en global pour le modifier depuis le code main et ainsi jongler avec les adresses de fonctions de callback
...
void InitLoraMacRadioEvent(void);
...
//Ajout F. Nolot
void LoraMac_radio_event_init() {
    RadioEvents.TxDone = OnRadioTxDone;
    RadioEvents.RxDone = OnRadioRxDone;
    RadioEvents.RxError = OnRadioRxError;
    RadioEvents.TxTimeout = OnRadioTxTimeout;
    RadioEvents.RxTimeout = OnRadioRxTimeout;
//   Radio.radio_event_init(&RadioEvents);
}
//
